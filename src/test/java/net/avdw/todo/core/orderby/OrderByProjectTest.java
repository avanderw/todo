...
public class OrderByProjectTest {
    private static final Path todoPath = Paths.get("target/test-resources/order-by-project/.todo/todo.txt");
    ...
    public void testProjectSuccess() {
        cliTester.execute("ls --order-by project").success();
    }
}
