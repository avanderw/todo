...
public class OrderByPluginTest {
    private static final Path todoPath = Paths.get("target/test-resources/order-by-plugin/.todo/todo.txt");
    ...
    public void testPluginSuccess() {
        cliTester.execute("ls --order-by moscow").success();
    }
}
