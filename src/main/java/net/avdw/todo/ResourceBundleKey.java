...
public final class ResourceBundleKey {
    public static final String ADD_DUPLICATE = "add.duplicate";
    public static final String BACKUP_COMPLETE = "backup.complete(path)";
    public static final String CHANGELOG_ADDED_HEADER = "changelog.added.header";
    public static final String CHANGELOG_DATE_HEADER = "changelog.date.header(date)";
    public static final String CHANGELOG_DATE_NA = "changelog.date.na";
    public static final String CHANGELOG_DONE_HEADER = "changelog.done.header";
    public static final String CHANGELOG_REMOVED_HEADER = "changelog.removed.header";
    ...
    public static final String GROUP_BY_DEPTH_UNSUPPORTED = "group.by.depth.unsupported";
    public static final String GROUP_BY_HEADING = "group.by.heading(type,title)";
    public static final String GROUP_BY_HEADING_2 = "group.by.heading.2(type,title)";
    public static final String GROUP_BY_HEADING_3 = "group.by.heading.3(type,title)";
    ...
    public static final String NO_GROUP = "no.group(type)";
    ...
    public static final String TOTAL_SUMMARY = "total.summary(filtered,total,todo,started,done)";
